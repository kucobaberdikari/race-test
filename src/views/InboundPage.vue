...
<div class="content-wrapper" >
   <div class="container-fluid card-nav rounded">
     <div class="row card col-md-12 bg-info " style="padding-left: 30px;padding-right:20px">
         <!-- <div class=""> -->
            <ol class="breadcrumb float-sm-left" >
               <li class="breadcrumb-item"><a href="#">Pages</a></li>
               <li class="breadcrumb-item active">Dashboard-Fulfillment-Dashboard</li>
               <li > Dashboard-Fulfillment-dashboard</li>
               </ol>
               <!-- <p class="m-0">Dashboard-Fulfillment-dashboard</p> -->
            ...
            <div class="col-md-6">
               <p >Dashboard-Fulfillment-dashboard</p>
         </div>
         <!-- </div> -->
     </div>
   </div>
